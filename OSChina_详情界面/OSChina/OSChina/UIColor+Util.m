...
+ (UIColor *)colorWithNormalTitleBar
{
    return [UIColor colorWithHex:0x909090 alpha:1.0];
}

+ (UIColor *)colorWithClickedTitleBar
{
    return [UIColor colorWithHex:0x009000 alpha:1.0];
}
